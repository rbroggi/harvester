# Harvester ![Running CI](https://github.com/rbroggi/harvester/workflows/Running%20CI/badge.svg) [![Coverage Status](https://coveralls.io/repos/github/beatlabs/harvester/badge.svg?branch=master)](https://coveralls.io/github/beatlabs/harvester?branch=master) [![Go Report Card](https://goreportcard.com/badge/github.com/rbroggi/harvester)](https://goreportcard.com/report/github.com/rbroggi/harvester) [![GoDoc](https://godoc.org/github.com/rbroggi/harvester?status.svg)](https://godoc.org/github.com/rbroggi/harvester) ![GitHub release](https://img.shields.io/github/release/beatlabs/harvester.svg)
